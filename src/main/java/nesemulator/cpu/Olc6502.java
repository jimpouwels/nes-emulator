...
public class Olc6502 {
    ...
    private void printInstructionSet() {
        System.out.println("\nInstructionSet");
        System.out.println("-----------------------------");
        for (int i = 0; i < instructionLookup.length; i += 16) {
            for (int y = i; y < i + 16; y++) {
                System.out.print(instructionLookup[y].opcode + "   ");
            }
            System.out.println();
            for (int y = i; y < i + 16; y++) {
                System.out.print(instructionLookup[y].addressingMode + "   ");
            }
            System.out.println();
            for (int y = i; y < i + 16; y++) {
                System.out.print(instructionLookup[y].cycles + "     ");
            }
