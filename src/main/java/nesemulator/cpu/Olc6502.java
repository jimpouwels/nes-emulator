...
public class Olc6502 {
    ...
    private Operation[] operationLookup = new Operation[]{
            operation("BRK", new Brk(), new Imm(), 7, 1), operation("ORA", new Ora(), new Izx(), 6, 2), unknown(), unknown(), operation("*NOP", new Nop(), new Imm(), 3, 2), operation("ORA", new Ora(), new Zp0(), 3, 2), operation("ASL", new Asl(), new Zp0(), 5, 2), unknown(), operation("PHP", new Php(), new Imp(), 3), operation("ORA", new Ora(), new Imm(), 2, 2), operation("ASL", new Asl(), new Imp(), 2, 1), unknown(), operation("*NOP", new Nop(), new Imp(), 4, 1), operation("ORA", new Ora(), new Abs(), 6, 3), operation("ASL", new Asl(), new Abs(), 6, 3), unknown(),
