...
public class Olc6502 {
    ...
    private Operation[] operationLookup = new Operation[]{
            operation("BRK", new Brk(), new Imm(), 7, 1), operation("ORA", new Ora(), new Izx(), 6, 2), unknown(), unknown(), unknown(), operation("ORA", new Ora(), new Zp0(), 3, 2), operation("ASL", new Asl(), new Zp0(), 5), unknown(), operation("PHP", new Php(), new Imp(), 3), operation("ORA", new Ora(), new Imm(), 2, 2), operation("ASL", new Asl(), new Imp(), 2), unknown(), unknown(), operation("ORA", new Ora(), new Abs(), 6, 3), operation("ASL", new Asl(), new Abs(), 6), unknown(),
            operation("BPL", new Bpl(), new Rel(), 2, 2), operation("ORA", new Ora(), new Izy(), 5, 2), unknown(), unknown(), unknown(), operation("ORA", new Ora(), new Zpx(), 4, 2), operation("ASL", new Ora(), new Zpx(), 6, 2), unknown(), operation("CLC", new Clc(), new Imp(), 2), operation("ORA", new Ora(), new Aby(), 4, 3), unknown(), unknown(), unknown(), operation("ORA", new Ora(), new Abx(), 4, 3), operation("ASL", new Asl(), new Abx(), 7), unknown(),
            ...
            operation("BMI", new Bmi(), new Rel(), 2, 2), operation("AND", new And(), new Izy(), 5, 2), unknown(), unknown(), unknown(), operation("AND", new And(), new Zpx(), 4, 2), operation("ROL", new Rol(), new Zpx(), 6), unknown(), operation("SEC", new Sec(), new Imp(), 2, 1), operation("AND", new And(), new Aby(), 4, 3), unknown(), unknown(), unknown(), operation("AND", new And(), new Abx(), 4, 3), operation("ROL", new Rol(), new Abx(), 7), unknown(),
            operation("RTI", new Rti(), new Imp(), 6), operation("EOR", new Eor(), new Izx(), 6, 2), unknown(), unknown(), unknown(), operation("EOR", new Eor(), new Zp0(), 3, 2), operation("LSR", new Lsr(), new Zp0(), 5), unknown(), operation("PHA", new Pha(), new Imp(), 3), operation("EOR", new Eor(), new Imm(), 2, 2), operation("LSR", new Lsr(), new Imp(), 2), unknown(), operation("JMP", new Jmp(), new Abs(), 3, 3), operation("EOR", new Eor(), new Abs(), 4), operation("LSR", new Lsr(), new Abs(), 6), unknown(),
            ...
            operation("CPX", new Cpx(), new Imm(), 2, 2), operation("SBC", new Sbc(), new Izx(), 6, 2), unknown(), unknown(), operation("CPX", new Cpx(), new Zp0(), 3, 2), operation("SBC", new Sbc(), new Zp0(), 3, 2), operation("INC", new Inc(), new Zp0(), 5), unknown(), operation("INX", new Inx(), new Imp(), 2), operation("SBC", new Sbc(), new Imm(), 2, 2), operation("NOP", new Nop(), new Imp(), 2), unknown(), operation("CPX", new Cpx(), new Abs(), 4, 3), operation("SBC", new Sbc(), new Abs(), 4), operation("INC", new Inc(), new Abs(), 6), unknown(),
            operation("BEQ", new Beq(), new Rel(), 2, 2), operation("SBC", new Sbc(), new Izy(), 5, 2), unknown(), unknown(), unknown(), operation("SBC", new Sbc(), new Zpx(), 4), operation("INC", new Inc(), new Zpx(), 6), unknown(), operation("SED", new Sed(), new Imp(), 2), operation("SBC", new Sbc(), new Aby(), 4, 3), unknown(), unknown(), unknown(), operation("SBC", new Sbc(), new Abx(), 4, 3), operation("INC", new Inc(), new Abx(), 7), unknown()
    };
